...
public class vettori_approfondimento_02
{
       ...
       {
            Scanner file = new Scanner(new File("elencoRegioneCittaDemo.txt"));
            int nRighe = 0;
            ...
            */
            ...
            file = new Scanner(new File("elencoRegioneCittaDemo.txt"));
            String[] rigaFile;
            int indice = 0;
            int righeErrore = 0;
            while(file.hasNextLine())
            ...
            {
                //regioni[i] != null è un controllo necessario perchè se la riga non era valida perché il numero di elementi
                //era diverso dai tre necessari, a quella posizione del vettore non è associato alcun valore.
                //Quindi quando cerchiamo di leggere la regione restituisce "null" ovvero il valore di default delle String.
                //Quindi oltre a controllare che la regione sia "lombardia" dobbiamo controllare che non sia null.
